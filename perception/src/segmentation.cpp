...
void Segmenter::Callback(const sensor_msgs::PointCloud2& msg) {
  ...
  tf_listener.waitForTransform("base_link", cloud_unfiltered->header.frame_id,
                               ros::Time(0), ros::Duration(5.0));
  tf::StampedTransform transform;
  try {
    tf_listener.lookupTransform("base_link", cloud_unfiltered->header.frame_id,
  ...
  PointCloudC::Ptr cloud_out(new PointCloudC());
  pcl_ros::transformPointCloud(*cloud_unfiltered, *cloud_out, transform);
